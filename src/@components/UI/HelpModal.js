...
const HelpModal = (props) => (
  <div className="help-overlay" onClick={props.onClick}>
    <div className="help-modal" aria-label="help-modal">
      <h1>👾 HOW TO PLAY 👾</h1>
      <div className="close-icon" role="application" aria-label="close-help">
      ...
      <p>
        In this take on everyone's favorite word game, players practice their programming vocab. Guess the{' '}
        <strong>CODE-LE</strong> in six tries.
        <br></br>
        <br></br>A guess must be a valid five-letter word related to web development or software engineering. Hit enter
        to submit.
        <br></br>
        <br></br>
      ...
      <hr></hr>
      <p>
        Unlike WORDLE, you can play CODE-LE as many times a day as you want. The goal is to make learning programming
        vocab fun!
      </p>
    </div>
  </div>
