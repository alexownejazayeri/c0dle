...
Avg. Guesses: ${gameData.averageGuesses}`;
  ...
  return (
    <div className="stats-overlay">
      <div className="stats-card" role="application" aria-label="stats-modal">
        <h3>STATISTICS</h3>
        <div className="close-icon" onClick={props.onStats} role="button" aria-label="close-stats">
        ...
        <div className="stats" role="application" aria-label="stats-cards">
          {!!gameData && <StatsCards gameData={gameData} />}
          {!gameData && <h1>No Game Data.</h1>}
        </div>
        <div className="chart">{!!gameData && <StatsChart guesses={gameData.guesses} />}</div>
